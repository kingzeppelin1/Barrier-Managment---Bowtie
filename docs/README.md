...
| — | *06 reserved — original brief had a roadmap section that is now superseded by [`prompts/`](prompts/) and [`10_MVP_BUILD_SEQUENCE.md`](10_MVP_BUILD_SEQUENCE.md). The number is held to keep the layout the package-structure doc references.* | — | — |
...
Every structural deviation from the spec, every framework choice, every database design call lives here. Use [`decisions/_TEMPLATE.md`](decisions/_TEMPLATE.md) as the starting point.

### `guides/` — Engineering guides

Operational documents — how to contribute, how to test, how to deploy, how to handle security incidents. Currently: [`guides/CONTRIBUTING.md`](guides/CONTRIBUTING.md). `TESTING.md`, `SECURITY.md`, and `DEPLOYMENT.md` land in later sprints.

### `references/` — Bibliography

Curated reading list for methodology / standards. See [`references/50_BOWTIE_ISO31000_LINKS.md`](references/50_BOWTIE_ISO31000_LINKS.md).
